  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        className={`
          flex items-center gap-1.5 sm:gap-2 px-2.5 py-1.5 sm:px-4 sm:py-2.5 rounded-xl
        ...
        `}
      >
        <span className="hidden sm:inline text-white/40 text-xs font-semibold tracking-widest uppercase mr-1">
          Tuning
        </span>
        {selected.name}
        <ChevronDown
